...
template <typename T> class BlasGeneric {
public:
  ...
  void geqrf(typename BlasGeneric<T>::Mems &a,
             typename BlasGeneric<T>::Mems &tau);

  void qrDecomposition(T *q, T *r, T *a);
  void qrDecomposition(typename BlasGeneric<T>::Mems &q,
                       typename BlasGeneric<T>::Mems &r,
                       typename BlasGeneric<T>::Mems &a);
...
protected:
  ...
  virtual void _geqrf(typename BlasGeneric<T>::Mems &a,
                      typename BlasGeneric<T>::Mems &tau) = 0;

  virtual void _qrDecomposition(T *q, T *r, T *a) = 0;
  virtual void _qrDecomposition(typename BlasGeneric<T>::Mems &q,
                                typename BlasGeneric<T>::Mems &r,
                                typename BlasGeneric<T>::Mems &a) = 0;
